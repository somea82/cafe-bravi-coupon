...
- 일주일 납품량 약 100개 수준의 주문 고객의 납품 제품에 대한 만족도는 높았지만 실제 매장 방문으로 이어지지 않는 문제가 있었고, 이를 해결하기 위해 오프라인 QR 진입부터 쿠폰 발급, 직원 사용 처리, 관리자 통계 확인까지 이어지는 작은 이벤트 시스템을 구축했습니다.
...
<p align="center">
  <img width="320" alt="화면 동작 GIF" src="https://github.com/user-attachments/assets/6c3136dd-0c50-41b3-9ebd-05acd0ad45a0" />
</p>
